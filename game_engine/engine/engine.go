...
func NewGame(size uint) *types.Game {
	...
	game.PositionUnit(types.WIZARD, player1, 4, 5, 1000)
	game.PositionUnit(types.DRAGON, player1, 3, 5, 5)
	game.PositionUnit(types.DRAGON, player1, 3, 6, 5)
	game.PositionUnit(types.DRAGON, player1, 4, 6, 5)
	game.PositionUnit(types.KNIGHT, player1, 1, 6, 1)
	game.PositionUnit(types.KNIGHT, player1, 2, 7, 1)
	game.PositionUnit(types.KNIGHT, player1, 3, 8, 1)

	// Position Player 2's units
	game.PositionUnit(types.WIZARD, player2, 5, 4, 1000)
	game.PositionUnit(types.DRAGON, player2, 5, 3, 5)
	game.PositionUnit(types.DRAGON, player2, 6, 3, 5)
	game.PositionUnit(types.DRAGON, player2, 6, 4, 5)
	game.PositionUnit(types.KNIGHT, player2, 6, 1, 1)
	game.PositionUnit(types.KNIGHT, player2, 7, 2, 1)
	game.PositionUnit(types.KNIGHT, player2, 8, 3, 1)
